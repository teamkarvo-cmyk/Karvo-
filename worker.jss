...
querySnapshot.forEach((doc) => {
  ...
  if (worker.Phone == phone) {
    ...
    document.querySelector(".rating").innerText = "⭐ " + worker.rating + " Rating";

    document.querySelectorAll("p")[1].innerText = "📍 " + worker.Test;
    document.querySelectorAll("p")[3].innerText = "Experience : " + worker.Experience + " Years";
    document.querySelectorAll("p")[4].innerText = "Category : " + worker.category;
